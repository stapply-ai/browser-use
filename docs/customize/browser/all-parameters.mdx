...
- `optimize_keyboard_events` (default: `False`): Skip keyDown/keyUp events for keyboard input, only send char events. Significantly reduces latency for remote browsers
